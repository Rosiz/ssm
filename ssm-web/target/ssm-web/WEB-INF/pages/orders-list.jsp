                    ...
                    <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <button type="button" class="btn bg-purple btn-xs"><a style="color: #ffffff" href="/product/toUpdate?id=${pro.id}">编辑</a></button>
                                <button type="button" class="btn bg-maroon btn-xs"><a style="color: #ffffff" href="/product/delete?id=${pro.id}">删除</a></button>
                            </td>
                        </tr>
                        </c:forEach>
                        </tbody>
